    ...
    public function getConfigTreeBuilder()
    {
        ...
        $treeBuilder->root('vince_cms')
            ->children()
                ...
                ->scalarNode('contact')->defaultValue('contact@sandbox.com')->end()
                ->scalarNode('defaultLocale')->defaultNull()->end()
                ->arrayNode('locales')
                    ...
                    ->children()
                        ...
                        ->arrayNode('block')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('repository')
                                    ->defaultValue('Vince\Bundle\CmsBundle\Entity\Repository\TranslatableRepository')
                                ->end()
                            ->end()
                        ->end()
